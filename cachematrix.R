...
## makeCacheMatrix 1)sets the value of the matrix, 2)gets the value of the matrix, 
##3)sets the value of the inverse of the matrix and 4)gets the value of the inverse of the matrix.
